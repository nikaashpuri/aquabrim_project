...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Controller.com_last_access_auth_or_not'
        db.add_column(u'machine_controller', 'com_last_access_auth_or_not',
                      self.gf('django.db.models.fields.IntegerField')(default=1, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Controller.com_last_access_auth_or_not'
        db.delete_column(u'machine_controller', 'com_last_access_auth_or_not')
    ...
    models = {
        ...
        'machine.controller': {
            ...
            'com_last_access_auth_or_not': ('django.db.models.fields.IntegerField', [], {'max_length': '100'}),
