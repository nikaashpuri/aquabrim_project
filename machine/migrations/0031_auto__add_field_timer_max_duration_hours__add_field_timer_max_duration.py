...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Timer.max_duration_hours'
        db.add_column(u'machine_timer', 'max_duration_hours',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=100),
                      keep_default=False)

        # Adding field 'Timer.max_duration_minutes'
        db.add_column(u'machine_timer', 'max_duration_minutes',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Timer.max_duration_hours'
        db.delete_column(u'machine_timer', 'max_duration_hours')

        # Deleting field 'Timer.max_duration_minutes'
        db.delete_column(u'machine_timer', 'max_duration_minutes')
