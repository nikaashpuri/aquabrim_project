...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Controller.license_type'
        db.add_column(u'machine_controller', 'license_type',
                      self.gf('django.db.models.fields.CharField')(default='test', max_length=100),
                      keep_default=False)

        # Adding field 'Controller.select_motor'
        db.add_column(u'machine_controller', 'select_motor',
                      self.gf('django.db.models.fields.CharField')(default='test', max_length=100),
                      keep_default=False)

        # Adding field 'Controller.max_motor_on'
        db.add_column(u'machine_controller', 'max_motor_on',
                      self.gf('django.db.models.fields.CharField')(default='test', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Controller.license_type'
        db.delete_column(u'machine_controller', 'license_type')

        # Deleting field 'Controller.select_motor'
        db.delete_column(u'machine_controller', 'select_motor')

        # Deleting field 'Controller.max_motor_on'
        db.delete_column(u'machine_controller', 'max_motor_on')
