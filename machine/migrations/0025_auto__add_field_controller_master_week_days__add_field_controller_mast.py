...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Controller.master_week_days'
        db.add_column(u'machine_controller', 'master_week_days',
                      self.gf('django.db.models.fields.IntegerField')(default=1, max_length=100),
                      keep_default=False)

        # Adding field 'Controller.master_hours'
        db.add_column(u'machine_controller', 'master_hours',
                      self.gf('django.db.models.fields.IntegerField')(default=1, max_length=100),
                      keep_default=False)

        # Adding field 'Controller.master_minutes'
        db.add_column(u'machine_controller', 'master_minutes',
                      self.gf('django.db.models.fields.IntegerField')(default=1, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Controller.master_week_days'
        db.delete_column(u'machine_controller', 'master_week_days')

        # Deleting field 'Controller.master_hours'
        db.delete_column(u'machine_controller', 'master_hours')

        # Deleting field 'Controller.master_minutes'
        db.delete_column(u'machine_controller', 'master_minutes')
