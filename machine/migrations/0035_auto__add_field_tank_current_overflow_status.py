...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tank.current_overflow_status'
        db.add_column(u'machine_tank', 'current_overflow_status',
                      self.gf('django.db.models.fields.IntegerField')(default=1, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tank.current_overflow_status'
        db.delete_column(u'machine_tank', 'current_overflow_status')
