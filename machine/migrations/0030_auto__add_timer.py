...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Timer'
        db.create_table(u'machine_timer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('controller', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['machine.Controller'])),
            ('week_days', self.gf('django.db.models.fields.IntegerField')(max_length=100)),
            ('timer_enable', self.gf('django.db.models.fields.IntegerField')(max_length=100)),
            ('timer_number', self.gf('django.db.models.fields.IntegerField')(max_length=100)),
            ('hours', self.gf('django.db.models.fields.IntegerField')(max_length=100)),
            ('m', self.gf('django.db.models.fields.IntegerField')(max_length=100)),
        ))
        db.send_create_signal(u'machine', ['Timer'])


    def backwards(self, orm):
        # Deleting model 'Timer'
        db.delete_table(u'machine_timer')
    ...
    models = {
        ...
        u'machine.timer': {
            ...
            'controller': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['machine.Controller']"}),
            'hours': ('django.db.models.fields.IntegerField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'm': ('django.db.models.fields.IntegerField', [], {'max_length': '100'}),
            'timer_enable': ('django.db.models.fields.IntegerField', [], {'max_length': '100'}),
