...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Controller.last_update'
        db.add_column(u'machine_controller', 'last_update',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 12, 18, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Controller.last_update'
        db.delete_column(u'machine_controller', 'last_update')
