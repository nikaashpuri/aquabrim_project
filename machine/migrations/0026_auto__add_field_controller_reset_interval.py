...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Controller.reset_interval'
        db.add_column(u'machine_controller', 'reset_interval',
                      self.gf('django.db.models.fields.IntegerField')(default=1, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Controller.reset_interval'
        db.delete_column(u'machine_controller', 'reset_interval')
