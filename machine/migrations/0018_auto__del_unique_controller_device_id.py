...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Controller', fields ['device_id']
        db.delete_unique(u'machine_controller', ['device_id'])


    def backwards(self, orm):
        # Adding unique constraint on 'Controller', fields ['device_id']
        db.create_unique(u'machine_controller', ['device_id'])
