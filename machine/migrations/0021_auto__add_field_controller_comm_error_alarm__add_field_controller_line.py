...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Controller.comm_error_alarm'
        db.add_column(u'machine_controller', 'comm_error_alarm',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10),
                      keep_default=False)

        # Adding field 'Controller.line_water_alarm'
        db.add_column(u'machine_controller', 'line_water_alarm',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Controller.comm_error_alarm'
        db.delete_column(u'machine_controller', 'comm_error_alarm')

        # Deleting field 'Controller.line_water_alarm'
        db.delete_column(u'machine_controller', 'line_water_alarm')
