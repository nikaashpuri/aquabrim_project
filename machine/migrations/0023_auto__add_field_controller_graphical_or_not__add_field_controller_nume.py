...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Controller.graphical_or_not'
        db.add_column(u'machine_controller', 'graphical_or_not',
                      self.gf('django.db.models.fields.IntegerField')(default=1, max_length=100),
                      keep_default=False)

        # Adding field 'Controller.numerical_or_not'
        db.add_column(u'machine_controller', 'numerical_or_not',
                      self.gf('django.db.models.fields.IntegerField')(default=1, max_length=100),
                      keep_default=False)

        # Adding field 'Controller.manual_or_not'
        db.add_column(u'machine_controller', 'manual_or_not',
                      self.gf('django.db.models.fields.IntegerField')(default=1, max_length=100),
                      keep_default=False)

        # Adding field 'Controller.auto_or_not'
        db.add_column(u'machine_controller', 'auto_or_not',
                      self.gf('django.db.models.fields.IntegerField')(default=1, max_length=100),
                      keep_default=False)

        # Adding field 'Controller.display_scroll_seconds'
        db.add_column(u'machine_controller', 'display_scroll_seconds',
                      self.gf('django.db.models.fields.IntegerField')(default=5, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Controller.graphical_or_not'
        db.delete_column(u'machine_controller', 'graphical_or_not')

        # Deleting field 'Controller.numerical_or_not'
        db.delete_column(u'machine_controller', 'numerical_or_not')

        # Deleting field 'Controller.manual_or_not'
        db.delete_column(u'machine_controller', 'manual_or_not')

        # Deleting field 'Controller.auto_or_not'
        db.delete_column(u'machine_controller', 'auto_or_not')

        # Deleting field 'Controller.display_scroll_seconds'
        db.delete_column(u'machine_controller', 'display_scroll_seconds')
