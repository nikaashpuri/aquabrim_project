...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Controller.max_duration_hours'
        db.add_column(u'machine_controller', 'max_duration_hours',
                      self.gf('django.db.models.fields.IntegerField')(default=2, max_length=100),
                      keep_default=False)

        # Adding field 'Controller.max_duration_minutes'
        db.add_column(u'machine_controller', 'max_duration_minutes',
                      self.gf('django.db.models.fields.IntegerField')(default=35, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Controller.max_duration_hours'
        db.delete_column(u'machine_controller', 'max_duration_hours')

        # Deleting field 'Controller.max_duration_minutes'
        db.delete_column(u'machine_controller', 'max_duration_minutes')
