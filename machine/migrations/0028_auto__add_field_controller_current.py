...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Controller.current'
        db.add_column(u'machine_controller', 'current',
                      self.gf('django.db.models.fields.FloatField')(default=1.5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Controller.current'
        db.delete_column(u'machine_controller', 'current')
