...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Controller.low_water_level'
        db.delete_column(u'machine_controller', 'low_water_level')
        ...
        # Deleting field 'Controller.full_water_level'
        db.delete_column(u'machine_controller', 'full_water_level')

        # Deleting field 'Controller.display'
        db.delete_column(u'machine_controller', 'display')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Controller.low_water_level'
        db.add_column(u'machine_controller', 'low_water_level',
                      self.gf('django.db.models.fields.IntegerField')(default='1', max_length=100),
                      keep_default=False)
        ...
        # Adding field 'Controller.full_water_level'
        db.add_column(u'machine_controller', 'full_water_level',
                      self.gf('django.db.models.fields.IntegerField')(default=1, max_length=100),
                      keep_default=False)

        # Adding field 'Controller.display'
        db.add_column(u'machine_controller', 'display',
