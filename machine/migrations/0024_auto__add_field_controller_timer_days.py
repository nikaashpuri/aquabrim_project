...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Controller.timer_days'
        db.add_column(u'machine_controller', 'timer_days',
                      self.gf('django.db.models.fields.CharField')(default='monday-friday', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Controller.timer_days'
        db.delete_column(u'machine_controller', 'timer_days')
