...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Controller.voltage_y'
        db.add_column(u'machine_controller', 'voltage_y',
                      self.gf('django.db.models.fields.IntegerField')(default=60, max_length=100),
                      keep_default=False)

        # Adding field 'Controller.voltage_z'
        db.add_column(u'machine_controller', 'voltage_z',
                      self.gf('django.db.models.fields.IntegerField')(default=60, max_length=100),
                      keep_default=False)

        # Adding field 'Controller.power_factor'
        db.add_column(u'machine_controller', 'power_factor',
                      self.gf('django.db.models.fields.FloatField')(default=1.2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Controller.voltage_y'
        db.delete_column(u'machine_controller', 'voltage_y')

        # Deleting field 'Controller.voltage_z'
        db.delete_column(u'machine_controller', 'voltage_z')

        # Deleting field 'Controller.power_factor'
        db.delete_column(u'machine_controller', 'power_factor')
