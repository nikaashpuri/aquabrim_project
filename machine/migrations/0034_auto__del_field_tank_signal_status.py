...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Tank.signal_status'
        db.delete_column(u'machine_tank', 'signal_status')


    def backwards(self, orm):
        # Adding field 'Tank.signal_status'
        db.add_column(u'machine_tank', 'signal_status',
