...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Tank.overflow_status'
        db.delete_column(u'machine_tank', 'overflow_status')

        # Adding field 'Tank.no_signal_alarm'
        db.add_column(u'machine_tank', 'no_signal_alarm',
                      self.gf('django.db.models.fields.IntegerField')(default=1, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Tank.overflow_status'
        db.add_column(u'machine_tank', 'overflow_status',
                      self.gf('django.db.models.fields.IntegerField')(default=1, max_length=100),
                      keep_default=False)

        # Deleting field 'Tank.no_signal_alarm'
        db.delete_column(u'machine_tank', 'no_signal_alarm')
